						...
						{isGreen ? (
							...
							<>
								...
								<StaticImage
									...
									alt="Nosso perfil no instagram."
									// https://instagram.com/polobrasilzero?igshid=NzZhOTFlYzFmZQ==
								/>
								<StaticImage
									className="ml-2 cursor-pointer w-13"
									src="../images/icon-youtube.svg"
									alt="Nossa página no youtube."
								/>
							</>
						)}
					</div>
				...
				<div className="max-lg:flex max-lg:flex-col max-lg:mt-8">
					...
					>
						...
						<div className="ml-10">
							...
							<li className="font-bold">Baixar e-book</li>
						</div>
					</ul>
				</div>
			</div>
