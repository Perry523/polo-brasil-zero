...
interface AboutUsProps {
	...
	sustentabilityRef: React.RefObject<HTMLDivElement>;
			...
			<div className="flex wrapper-full lg:mt-24 items-center max-lg:flex-col">
				...
				<div className="lg:ml-10 max-lg:text-center">
					...
					<p className="mt-2 text-green-800">
						Nosso Chamado para liderança em sustentabilidade é inspirar, motivar
						e promover uma mudança cultural, acreditamos que impactar
